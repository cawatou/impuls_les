		...
		<div class="container">
			...
			<div class="grade gradeP">
				...
				<div class="row row_mid">
					<div>
						<div class="comment_left comment_block col-md-5">
							<p>Премиальный сорт, отличающийся от Экстры наличием исключительно здоровых сросшихся сучков диаметром до 10 мм, в количестве не более одной штуки на погонный метр изделия</p>
						</div>
					</div>
					<div class="col-md-2">
				...
				<div class="row row_btm">
					<div class="col-md-12">
						<div class="col-md-4"></div>
						<div class="comment_top comment_block col-md-4">
							Наша компания считает разумным не разделять эти два высоких сорта и объединить их по некоторой усредненной цене в одну условную категорию – «Экстра+Прима» (ЭП).
						</div>
						<div class="col-md-4"></div>
					</div>
				</div>
