		...
		<div class="container">
			...
			<div class="grade gradeP">
				...
				<div class="row row_mid">
					...
					<div>
						<div class="comment_right comment_block col-md-5">
							<p>Наша компания считает разумным не разделять эти два высоких сорта и объединить их по некоторой усредненной цене в одну условную категорию – «Экстра+Прима» (ЭП).</p>
						</div>
					</div>
				</div>
